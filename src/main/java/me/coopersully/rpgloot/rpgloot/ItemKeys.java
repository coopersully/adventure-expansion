...
public class ItemKeys {
    ...
    public static NamespacedKey nightmareFuel = new NamespacedKey(RPGLoot.getPlugin(), "nightmare_fuel");
    public static NamespacedKey nightmare = new NamespacedKey(RPGLoot.getPlugin(), "nightmare");

    public static NamespacedKey traveler = new NamespacedKey(RPGLoot.getPlugin(), "traveler");
    ...
    public static NamespacedKey stew = new NamespacedKey(RPGLoot.getPlugin(), "stew");
    public static NamespacedKey ender = new NamespacedKey(RPGLoot.getPlugin(), "ender");
    ...
    public static NamespacedKey witherBow = new NamespacedKey(RPGLoot.getPlugin(), "wither_bow");
    public static NamespacedKey evokerBow = new NamespacedKey(RPGLoot.getPlugin(), "evoker_bow");
    public static NamespacedKey minersHat = new NamespacedKey(RPGLoot.getPlugin(), "miners_hat");
